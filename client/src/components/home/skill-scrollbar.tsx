...
export default function SkillScrollbar() {
  // Double the skills array to create the continuous scrolling effect
      ...
      <div className="skill-scrollbar-container overflow-hidden relative">
        <div className="skill-scrollbar">
          {doubledSkills.map((skill, index) => (
            <div key={index} className="flex flex-col items-center mx-4 pop-out-effect">
              <div className={`w-16 h-16 rounded-full flex items-center justify-center ${skill.bgColor} ${skill.textColor} mb-1`}>
                {skill.icon}
              </div>
